...
function renderGlutenFreeCrust() {
  ...
  const convertToArray = [...document.querySelector('.crust').classList]; // spread operator
  if(convertToArray.includes('crust-gluten-free')){
...
document.querySelector('.btn.btn-pepperoni').addEventListener('click', function () {
  state.pepperoni = !state.pepperoni; // true -> false || false -> true
  renderEverything();
});
