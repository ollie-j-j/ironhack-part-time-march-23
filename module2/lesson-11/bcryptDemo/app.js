const bcrypt = require('bcrypt'); // responsible for hashing passwords
const saltRounds = 10;
// salt round 1: uhiucsieughusy
//
// salt round 10: $2b$10$OI.knjhTALoqtmyD.kkv5O
...
const verifyPass2 = bcrypt.compareSync('some random string', hash2);
